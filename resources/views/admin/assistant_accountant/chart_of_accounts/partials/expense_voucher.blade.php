        ...
        $(document).ready(function (){
            ...
            function initializeDataTable() {
                ...
                dataTable = $('#dataTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('expense.vouchers.list.of.assistant.accountant') }}',
                    columns: [
                    {data: 'id', name: 'id'},
            ...
            function approveData(id) {
                ...
                .then((result) => {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/approve/expense/voucher/by/assistant/accountant/' + id,
                        dataType: 'json',
            ...
            function rejectData(id) {
                ...
                .then((result) => {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/reject/expense/voucher/by/assistant/accountant/' + id,
                        dataType: 'json',
                        success: function(response) {
                        Swal.fire(
                            'Rejected!',

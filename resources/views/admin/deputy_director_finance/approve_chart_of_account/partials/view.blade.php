                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-bordered display" style="width: 100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" value="{{ $chartOfAccount->chart_no }}" disabled>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('approve.chart.of.account') }}" type="submit" class="btn btn-danger font-weight-medium rounded-pill px-4 mt-4">
                                Back
                            </a>
                        </div>
                    </div>

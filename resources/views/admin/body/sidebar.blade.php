<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
      ...
      <div
        ...
        style="
          background: url({{ asset('admin/assets/images/background/user-info.jpg') }})
            no-repeat;
        "
      >
      @php
        ...
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse first-level">
              <li class="sidebar-item">
                <a href="#" class="sidebar-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Final Approval or Objection on Expense Vouchers">
              ...
              <li class="sidebar-item">
                <a href="#" class="sidebar-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Approve Chart of Accounts for DDOs">
                  <i class="mdi mdi-adjust"></i>
          ...
          <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse first-level">
              <li class="sidebar-item">
                <a href="#" class="sidebar-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Approve or Raise Objections on Expense Vouchers">
                  <i class="mdi mdi-adjust"></i>
          ...
          <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse first-level">
              <li class="sidebar-item">
                <a href="#" class="sidebar-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Approve or Raise Objections on Expense Vouchers submitted by DDOs">
                  <i class="mdi mdi-adjust"></i>
          ...
          <li class="sidebar-item">
            ...
            <ul aria-expanded="false" class="collapse first-level">
              <li class="sidebar-item">
                <a href="#" class="sidebar-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Add Expenses Vouchers in Different Chart of Accounts">
                  <i class="mdi mdi-adjust"></i>
